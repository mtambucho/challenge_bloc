...
abstract class $CartItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({Recipe recipe, int count});
...
class _$_CartItem implements _CartItem {
  _$_CartItem({required this.recipe, this.count = 1});
  ...
  @override
  String toString() {
    return 'CartItem(recipe: $recipe, count: $count)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, recipe, count);
...
abstract class _CartItem implements CartItem {
  factory _CartItem({required final Recipe recipe, final int count}) =
      _$_CartItem;
